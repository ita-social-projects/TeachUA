...
public class HtmlUtils {
    ...
    public static final Safelist DESC_SAFELIST = Safelist.relaxed().addTags("s", "iframe")
            .addAttributes("span", "class", "style").addAttributes("a", "href", "rel", "target")
            .addAttributes("div", "class").addAttributes("p", "class").addAttributes("li", "class")
            .addAttributes("img", "class").addAttributes("iframe", "class", "allowfullscreen", "src", "frameborder");
     ...
     *
     * @param desc
     *            put html code to validate
     *
     * @throws IncorrectInputException
     *             throws if the code has forbidden tags and attributes
     *
     * @see Safelist
     */
