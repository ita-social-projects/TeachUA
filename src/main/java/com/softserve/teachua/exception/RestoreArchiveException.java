...
public class RestoreArchiveException extends IllegalStateException{
    ...
    public static final String CANT_FIND_CLASS =
            "Can't find serviceClass " + PROGRAM_WAS_CHANGED;
    public static final String CANT_READ_JSON =
            "JSON is not readable " + PROGRAM_WAS_CHANGED;
