...
//                .and()
                ...
                .antMatchers(HttpMethod.DELETE,"/api/file").hasAnyRole("MANAGER","ADMIN")
                .antMatchers(HttpMethod.POST,"/api/file").hasAnyRole("MANAGER","ADMIN")
                .antMatchers(HttpMethod.PUT,"/api/file").hasAnyRole("MANAGER","ADMIN")
