...
public class FeedbackServiceImpl implements FeedbackService {
    ...
    @Autowired
    public FeedbackServiceImpl(FeedbackRepository feedbackRepository, DtoConverter dtoConverter, ClubRepository clubRepository, ArchiveService archiveService, UserServiceImpl userService, UserRepository userRepository) {
