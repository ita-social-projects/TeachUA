...
public interface UserService {
     ...
     *             if user verification code is incorrect.
     */
     ...
     *
     * @param userLogin
     *            - place dto {@code UserResetPassword} with all params.
     *
     ...
     *            - place dto {@code SuccessUserPasswordReset} with all params.
     *
     * @return new {@code SuccessUserPasswordReset}
     */
     ...
     *            - place dto {@code UserPasswordUpdate} with all params.
     */
