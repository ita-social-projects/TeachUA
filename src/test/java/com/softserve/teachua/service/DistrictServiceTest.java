...
class DistrictServiceTest {
    ...
    @Test
    void getDistrictByCorrectIdShouldReturnDistrict() {
    ...
    @Test
    void getDistrictByWrongIdShouldReturnNull() {
    ...
    @Test
    void getDistrictProfileByIdShouldReturnDistrictResponse() {
        when(districtRepository.findById(CORRECT_DISTRICT_ID)).thenReturn(Optional.of(district));
    ...
    @Test
    void getDistrictByCorrectNameShouldReturnDistrict() {
    ...
    @Test
    void getDistrictByWrongNameShouldThrowNotExistException() {
        when(districtRepository.findFirstByName(WRONG_DISTRICT_NAME)).thenReturn(Optional.empty());
        assertThatThrownBy(() -> districtService.getDistrictByName(WRONG_DISTRICT_NAME)).isInstanceOf(
                NotExistException.class);
    }

    @Test
    void addDistrictShouldReturnSuccessCreatedDistrict() {
    ...
    @Test
    void addDistrictShouldThrowAlreadyExistException() {
        when(districtRepository.existsByName(CORRECT_DISTRICT_NAME)).thenReturn(true);
        assertThatThrownBy(() -> districtService.addDistrict(districtProfile)).isInstanceOf(
                AlreadyExistException.class);
    }

    @Test
    void getListOfDistrictsShouldReturnListOfDistrictResponses() {
    ...
    @Test
    void getListOfDistrictsByCorrectCityNameShouldReturnListOfDistrictResponses() {
    ...
    @Test
    void getListOfDistrictsByWrongCityNameShouldReturnListOfDistrictResponses() {
