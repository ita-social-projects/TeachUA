...
public class ClubAdvancedSearchRepository {
    ...
    public static ClubSearchTestEntity getClubWithOneCategoryName() {
        return ClubSearchTestEntity
                .builder()
                .categoriesNames(Arrays.asList("Спортивні секції"))
                .build();
    }
    ...
    public static ClubSearchTestEntity getClubWithManyCategoryName() {
        return ClubSearchTestEntity
                .builder()
                .categoriesNames(Arrays.asList("Програмування, робототехніка, STEM",
    ...
    public static ClubSearchTestEntity getClubAsListWithAllCorrectData() {
        return ClubSearchTestEntity
                ...
                .districtName("Деснянський")
                .stationName("Академмістечко")
                .categoriesNames(Arrays.asList("Студії раннього розвитку"))
                .build();
    }
