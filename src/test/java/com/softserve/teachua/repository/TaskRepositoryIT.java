...
public class TaskRepositoryIT {
    ...
    private final Challenge challenge1 = Challenge.builder()
            .name(CHALLENGE_ONE)
            .title(CHALLENGE_ONE)
            .description(CHALLENGE_ONE)
            .picture(CHALLENGE_ONE)
            .sortNumber(1L)
            .isActive(true)
            .build();
    private final Challenge challenge2 = Challenge.builder()
            .name(CHALLENGE_TWO)
            .title(CHALLENGE_TWO)
            .description(CHALLENGE_TWO)
            .picture(CHALLENGE_TWO)
            .sortNumber(2L)
            .isActive(true)
            .build();
    ...
    public void findTasksByChallengeAndStartDateBeforeOrderByStartDateShouldReturnSortedListOfTasks() {
        assertThat(taskRepository
                .findTasksByChallengeAndStartDateBeforeOrderByStartDate(challenge1, LocalDate.now().plusDays(2)))
                .isEqualTo(tasksWithChallenge1Sorted);
    }

    @Test
    public void findTasksByChallengeAndStartDateBeforeOrderByStartDateShouldReturnEmptyListWithWrongDate() {
        assertThat(taskRepository
                .findTasksByChallengeAndStartDateBeforeOrderByStartDate(challenge1, LocalDate.now().plusDays(0)))
    ...
    public void findTasksByChallengeAndStartDateBeforeOrderByStartDateShouldReturnEmptyListWithChallengeWithoutTasks() {
        assertThat(taskRepository
                .findTasksByChallengeAndStartDateBeforeOrderByStartDate(challenge2, LocalDate.now().plusDays(2)))
                .isEqualTo(Collections.emptyList());
    }
}
