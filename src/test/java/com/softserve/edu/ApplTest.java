...
public class ApplTest {
    ...
    public void checkApp() {
        ...
        isCredentials = isCredentials && (System.getenv("JWT_SECRET") != null)
                && !System.getenv("JWT_SECRET").isEmpty();
        isCredentials = isCredentials && (System.getenv("DATASOURCE_URL") != null)
                && !System.getenv("DATASOURCE_URL").isEmpty();
        isCredentials = isCredentials && (System.getenv("DATASOURCE_USER") != null)
                && !System.getenv("DATASOURCE_USER").isEmpty();
        isCredentials = isCredentials && (System.getenv("DATASOURCE_PASSWORD") != null)
                && !System.getenv("DATASOURCE_PASSWORD").isEmpty();
