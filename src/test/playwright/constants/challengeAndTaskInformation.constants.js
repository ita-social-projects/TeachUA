...
export const newChallengeCorrectDetails = {
...
export const editedChallengeCorrectDetails = {
    SEQUENCE_NUMBER: '999999',
    NAME: 'Super EDITED Challenge',
    TITLE: 'EDITED test title',
    DESCRIPTION: 'This is a test description EDITED EDITED EDITED EDITED EDITED EDITED EDITED EDITED EDITED EDITED'
}

export const newTaskCorrectDetails = {
...
export const editedTaskCorrectDetails = {
