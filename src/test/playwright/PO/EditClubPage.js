...
class EditClubPage extends AddClubPage {
    constructor(page) {
        ...
        this.editLocationButton = this.page.locator('ul.ant-list-item-action li span[aria-label="edit"]');
        this.deleteLocationButton = this.page.locator('ul.ant-list-item-action li span[aria-label="delete"]');
        ...
        this.locationCloseButton = this.page.locator('div.ant-modal-content').filter({hasText: EDIT_CLUB_PAGE.geographicCoordinates}).locator('button[aria-label="Close"]');
        ...
        this.completeButton = this.page.getByRole('button', { name: EDIT_CLUB_PAGE.complete });
